...
cat << EOT > /etc/bird/as1111-bird.conf
...
ip netns exec as1111 bird -c /etc/bird/as1111-bird.conf -P /var/run/as1111-bird.pid -s /var/run/as1111-bird.ctl

ip netns exec as1111 netstat -an
